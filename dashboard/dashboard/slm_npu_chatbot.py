...
답변:"""
            ...
            # 시스템 메시지 (프로젝트 컨텍스트 포함)
            system_message = f"""당신은 Deep-Guardian 포트홀 탐지 시스템의 AI 어시스턴트입니다.

{PROJECT_CONTEXT}

제공된 데이터와 프로젝트 컨텍스트를 바탕으로 사용자의 질문에 정확하고 친절하게 답변합니다.
위험도, 우선순위 점수, 깊이 비율 등의 의미를 정확히 이해하고 설명합니다."""
            ...
            response = requests.post(
                ...
                json={
                    ...
                    'max_tokens': 1000,  # 응답 길이 증가 (500 → 1000)
                    'temperature': 0.7
                },
